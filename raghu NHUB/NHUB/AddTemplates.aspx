            ...
            <h2 class="text-center">
                ...
                <table class="auto-style1">
                    ...
                    <tr>
                        ...
                        <td style="width: 486px">
                            <asp:Button ID="Button5" runat="server" style="position: relative; left: -109px; top: 3px; width: 37px; height: 22px" Text="on" />
&nbsp;&nbsp;
                            <asp:Button ID="Button6" runat="server" style="position: relative; left: -123px; top: 3px; width: 33px; height: 22px" Text="off" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="FileUpload1" ErrorMessage="Upload html file" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
